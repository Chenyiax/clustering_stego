...
for i, j in zip(params_without_secret, params_with_secret):
    ...
    plt.plot(bin_centers1, hist_tensor1, color=color[0], label='Cover model', linewidth=line_width)
    plt.plot(bin_centers2, hist_tensor2, color=color[1], label='Stego model', linewidth=line_width)
